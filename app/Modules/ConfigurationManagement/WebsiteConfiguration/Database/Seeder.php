...
class Seeder extends SeederClass
{
        ...
        foreach ($settings as $title) {
            ...
            foreach ($title['values'] as $value) {
                self::$SettingValueModel::create([
                    ...
                    'title' => isset($value['title']) ? $value['title'] : $setting_title->title,
    ...
    {
        return <<<HTML
        <div class="privacy_policy_content mb-2" id="privacy_policy_content">
            <div class="privacy_policy_inner">
                <h5>ETEK BD Privacy Policy</h5>
                <p>At ETEK BD, we prioritize your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, and safeguard your data when you visit our website or make a purchase from our online store.</p>

                <h6>Information We Collect</h6>
                <p>When you browse our site or make a purchase, we collect essential information to enhance your shopping experience. This includes your IP address, browser details, and device information. If you place an order, we gather personal details such as your name, billing address, shipping address, email, phone number, and payment information.</p>

                <h6>How We Use Your Information</h6>
                <p>The information we collect is used to process and deliver your orders, manage payments, and provide customer support. We may also use your information to communicate with you about promotions, new products, or important updates related to your purchases.</p>

                <h6>Data Protection</h6>
                <p>We take the security of your personal data seriously. ETEK BD uses advanced security measures to protect your information from unauthorized access, disclosure, or misuse.</p>

                <h6>Sharing Your Information</h6>
                <p>Your personal information is never sold or shared with third parties, except as necessary to fulfill your order (e.g., with delivery services or payment gateways). In such cases, we ensure that these partners comply with strict data protection standards.</p>

                <h6>Your Rights</h6>
                <p>You have the right to access, update, or request the deletion of your personal information at any time. If you have any concerns or requests regarding your data, please contact our support team.</p>

                <h6>Updates to This Policy</h6>
                <p>ETEK BD reserves the right to update this Privacy Policy periodically. We encourage you to review it regularly to stay informed about how we are protecting your information.</p>

                <h6>Contact Us</h6>
                <p>If you have any questions regarding this Privacy Policy or your data, please contact us at <a href="mailto:support@etek.com.bd">support@etek.com.bd</a>.</p>
            </div>
        </div>
        HTML;
    }
