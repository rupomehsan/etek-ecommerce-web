...
use App\Modules\Auth\Actions\OAuthCallBackRedirect;
use App\Modules\Auth\Actions\RemoveAccount;
...
class Controller extends ControllersController
{
    ...
    public function oAuthCallBackRedirect()
    {
        $data = OAuthCallBackRedirect::execute();
        return $data;
    }
    public function RemoveAccount()
    {
        $data = RemoveAccount::execute();
        return $data;
    }
}
