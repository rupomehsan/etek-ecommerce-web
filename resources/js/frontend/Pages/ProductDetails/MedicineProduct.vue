        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card my-3 bg-dummy-image w-100" style="min-height: 300px;">
                    <a :href="load_image(`${product_details.product_image?.url}`)" data-lightbox="prouct-set"
                        data-title="Product image" class="bg-white">
                        <img :src="load_image(`${product_details.product_image?.url}`)"
                            :alt="product_details.product_image?.url" class="img-fluid image_zoom_cls-0">
                    </a>
                </div>
                <div class="card p-3">
                    <div class="bg-white rounded-10 mt-20  border-1-grey300 rounded-10 undefined"
                        ...
                        <div class="d-flex justify-space-between p-20">
                            <div class="text-18 text-primary fw-500 d-flex"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <h2 class="ml-10">{{ product_details.title }}</h2>
                            </div>

                        </div>
                        <div class="d-flex flex-column px-20">
                            <div v-html="product_details?.medicine_product.p_description"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 my-3">
                <div class="card ">
                    ...
                    <div class="d-flex justify-content-between gap-2 p-2 align-items-center">
                        <p> <span class="fw-bold">{{ product_details?.total_views }}</span> People viewed this</p>
                    ...
                    <div class="single-product-info py-2 px-3">
                        <div class="position-relative">
                            <div class="border-b1-grey300 py-10">
                                <div class="d-flex  justify-content-between my-2">
                                    <h5 class="text-capitalize text-24 fw-600 text-black">{{ product_details.title
                                        }}</h5>
                                ...
                                <span class="d-flex text-18 text-grey600 text-capitalize">
                                    {{ product_details.medicine_product?.p_strength }}
                                </span>
                            </div>
                        ...
                        <div class="product-core-info-list w-100">
                            ...
                            <div class="d-flex align-items-center">
                                <!-- <img :src="load_image(`${product_details.product_brand?.image}`)" height="60"
                                    width="80" alt=""> -->
                                <Link :href="`/product-details/${product_details?.slug}`"
                        ...
                        <div class="product-core-info-list w-100">
                            ...
                            <span @click="genericProducts"
                                ...
                                {{ product_details.medicine_product?.p_generic_name }}
                            </span>
                            ...
                            <div class="d-flex flex-column gap-8">
                                <div class="">
                                    <span class="d-flex text-16 text-grey900 fw-500">
                                        <div>
                                            {{
                                                product_details.medicine_product_verient?.pu_b2c_base_unit_multiplier
                                            }}
                                            <span
                                                v-if="product_details.medicine_product_verient?.pu_base_unit_label == product_details.medicine_product_verient?.pu_b2c_sales_unit_label">
                                                x
                                            </span>
                                            {{ product_details.medicine_product_verient?.pu_base_unit_label }}
                                            <span
                                                v-if="product_details.medicine_product_verient?.pu_base_unit_label != product_details.medicine_product_verient?.pu_b2c_sales_unit_label">
                                                -
                                                {{
                                                    product_details.medicine_product_verient?.pu_base_unit_multiplier
                                                }}
                                                {{
                                                    product_details.medicine_product_verient?.pu_b2c_sales_unit_label
                                                }}
                                            </span>
                        ...
                        <div class=" display-flex-center mb-24">
                            <div class="product-price-widget offer-price p-0">
                                ...
                                <span class="offer-main-price">
                                    {{ product_details.medicine_product_verient?.pv_b2c_price }} BDT
                                </span>
                            </div>
                            <div class="product-price-widget regular-price p-0">
                                ...
                                <span class="regular-main-price">
                                    {{ product_details.medicine_product_verient?.pv_b2c_mrp }} BDT
                                </span>
                            </div>
                            <span class="product-price-save">
                                {{ product_details.medicine_product_verient?.pv_b2c_discount_percent }} % SAVE
                            </span>
                        </div>
                    ...
                    <div class="product-buttons ps-3 d-flex flex-wrap gap-2 mt-2">
                        <button @click="is_auth ? add_to_cart(product_details.id) : openAccount()"
                            class="btn btn-normal">
                            <i class="icon icon-shopping-cart"></i>
                            Add to Cart
                        </button>
                        <a @click="is_auth ? add_to_wish_list(product_details.id) : openAccount()"
...
export default {
    ...
    computed: {
        ...
        uniqueQuantities() {
            let qty = this.product_details?.medicine_product_verient?.pv_b2c_max_qty;
            qty = Number(qty);
            return !isNaN(qty) && qty > 0 ? Array.from({ length: qty }, (_, i) => i + 1) : [];
        }
    }
