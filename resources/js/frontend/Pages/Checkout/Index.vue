                                ...
                                <div class="col-lg-6 col-sm-12 col-xs-12">
                                    <div class="theme-form">
                                        <div class="row check-out">
                                            <div
                                                class="checkout-title text-center"
                                            >
                                                <h3>
                                            ...
                                            <div class="form-group required">
                                                <label for="state_division_id"
                                                    >Division</label
                                                >
                                                <select
                                                    name="state_division_id"
                                                    id="state_division_id"
                                                    class="form-control"
                                                ...
                                                >
                                                    ...
                                                    <option
                                                        ...
                                                        :selected="
                                                            division.id ==
                                                            user_address_info?.state_division_id
                                                                ? 'selected'
                                                                : ''
                                                        "
                                                    >
    ...
    methods: {
        ...
        checkoutFormSubmit: async function ($event) {
            ...
            let response = await window.privateAxios(
                "/customer-ecommerce-order-placed",
                "post",
                formData
            );
            if (response.status === "success") {
                if (response.data.order_details?.payment_method === "cod") {
                    ...
                    response.data.order_details?.payment_method === "online"
                ) {
        ...
        get_district_by_state_division_id: async function (state_division_id) {
            ...
            let response = await axios.get(
                `/get-district-by-division-id/${state_division_id}`,
                {
                    params: {
                        sort_by_col: "id",
                        sort_type: "asc",
        ...
        get_station_by_district_id: async function (district_id) {
            let response = await axios.get(
                `/get-station-by-district-id/${district_id}`,
                {
                    params: {
                        sort_by_col: "id",
                        sort_type: "asc",
        ...
        checkoutPopUp: async function (data) {
            let payment_res = await window.axios.get(
                `pay-via-ajax?order_id=${data.order_details.order_id}`
            );
